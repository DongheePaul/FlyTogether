    ...
    private class Token extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected Map<String, String> doInBackground(Void... voids) {
            try {
                ...
                Long tokenbalance1 = tokenbalance.longValue();

                Map<String,String> result = new HashMap<>();
                result.put("tokenname",tokenname);
                result.put("tokensymbol",tokensymbol);
                android.util.Log.e("토큰밸런스", String.valueOf(tokenbalance));
                android.util.Log.e("토큰밸런스 long", String.valueOf(tokenbalance1));
