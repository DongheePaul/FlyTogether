...
import com.dong.AR.analytics.AnalyticsEvents;
import com.dong.AR.analytics.Fa;
import com.dong.AR.model.Stroke;
import com.dong.AR.rendering.AnchorRenderer;
import com.dong.AR.rendering.BackgroundRenderer;
import com.dong.AR.rendering.LineShaderRenderer;
import com.dong.AR.rendering.LineUtils;
import com.dong.AR.rendering.PointCloudRenderer;
import com.dong.AR.view.BrushSelector;
import com.dong.AR.view.ClearDrawingDialog;
import com.dong.AR.view.DebugView;
import com.dong.AR.view.ErrorDialog;
import com.dong.AR.view.LeaveRoomDialog;
import com.dong.AR.view.PairButton;
import com.dong.AR.view.PairButtonToolTip;
import com.dong.AR.view.PairView;
import com.dong.AR.view.PlaybackView;
import com.dong.AR.view.RecordButton;
import com.dong.AR.view.TrackingIndicator;
...
import com.nhancv.kurentoandroid.BuildConfig;
...
//    private DebugMeshShaderRenderer mLineShaderRenderer = new DebugMeshShaderRenderer();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.e("null이라고?", String.valueOf(mDebugView));
...
//        mPairSessionManager.updateStroke(index, mStrokes.get(index));
    ...
    private void update() {
        try {
            ...
            // Get projection matrix. => 투영모형을 얻는다. 즉 카메라 비친 모습과 같은 모형(매트릭스)을 구함.
