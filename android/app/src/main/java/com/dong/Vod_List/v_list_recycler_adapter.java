...
public class v_list_recycler_adapter extends RecyclerView.Adapter<v_list_recycler_adapter.ViewHolder> {
    Context context;
    ArrayList<v_list_item> v_list_itemArrayList = new ArrayList<>();
    v_list_item v_item;

    //생성자
    public v_list_recycler_adapter (Context context, ArrayList<v_list_item> v_list_itemarray) {
        this.context = context;
        this.v_list_itemArrayList = v_list_itemarray;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        v_item = v_list_itemArrayList.get(position);
        ...
        Glide.with(holder.itemView.getContext())
                .load("http://13.209.238.21/flytogetherVideo/thumbnail/"+v_item.getSt_Thumbnail())
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                v_item = v_list_itemArrayList.get(position);
                String st_vodTitle = holder.tv_vodname.getText().toString();
                Log.e("vodTitle check, vodlist", st_vodTitle);
                Intent intent = new Intent(v.getContext(), VodPlayActivity.class);
                intent.putExtra("vod_title", st_vodTitle);
    ...
    public int getItemCount() {
        return v_list_itemArrayList.size();
    }
